...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'DIIT'],
            ['type' => 'system_name', 'description' => 'Daffodill Institute Of IT'],
            ['type' => 'term_ends', 'description' => '7/8/2023'],
            ['type' => 'term_begins', 'description' => '7/10/2023'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => '18B Mohammadpur, Dhaka'],
            ['type' => 'system_email', 'description' => 'Diit@diit.com'],
